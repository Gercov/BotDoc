...
Добавлять модераторов в черный список может стример, и другие модераторы которым он выдал специальную роль.

Имеется всего две роли:
- **1** - Эта роль может добавлять модераторов в черный список 
