...
Комманды:
- **!addrole «роль» «никнейи»** - Выдает роль модератору. **Пример - !addrole 1 oldboty**. *Примечание: 1) Чтобы выдать человеку другую роль, просто замените цифру в команде*.
- **!delrole «роль» «никнейи»** - Лишает модератора всех ролей. **Пример - !delrole oldboty**.
- **!banmod «никнейи»** - Запрещает доступ к боту **Пример - !banmod oldboty**.
- **!unbanmod «никнейи»** - Восстанавливает доступ к боту **Пример - !unbanmod oldboty**.
